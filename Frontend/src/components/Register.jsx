                ...
                <div className="w-full max-w-4xl">
                    ...
                    <div className="bg-gray-800 p-6 sm:p-8 md:p-12 rounded-lg shadow-lg">
                        ...
                        <div className="space-y-6">
                            ...
                            <button onClick={() => {     submitRegisterForm(); }} className={`w-full bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded-lg transition duration-300 disabled:opacity-75 ${     load ? "cursor-wait" : "cursor-default" }`} disabled={load}>
